						...
						<div class="bg-light rounded p-5">
							<form>
								...
								<div class="row g-3">
									...
									<div class="col-12 col-sm-3">
										<input type="text" class="form-control bg-light border-0" disabled="disabled" placeholder="재학중인 학교"
											readonly="readonly" style="height: 55px;">
									</div>
									<div class="col-12 col-sm-9">
									...
									<div class="col-4">
										<<<<<<< HEAD <button class="btn btn-primary w-100 py-3" type="button" id="btnUpdate">수정하기</button>
											=======
									...
									<div class="col-4">
										<<<<<<< HEAD <button class="btn btn-danger w-100 py-3" type="button" id="btnDelete">탈퇴하기</button>
											=======
