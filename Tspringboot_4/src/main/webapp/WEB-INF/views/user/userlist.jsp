...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
	<div class="container py-5">
			...
			<div class="col-lg-3">
				...
				<div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
					...
					<div class="link-animated d-flex flex-column justify-content-start">
						...
						<a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"
							href="/mywrite/${user.no}"><i class="bi bi-arrow-right me-2"></i>커뮤니티</a> <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"
		...
		<c:if test="${users.first==false }">
			<li class="page-item">
			<a class="page-link" href="?page=${users.number-1 }">이전</a>
			</li>
		</c:if>
		<c:if test="${users.last==false }">
			<li class="page-item">
			<a class="page-link" href="?page=${users.number+1 }">다음</a>
			</li>
		</c:if>
		</ul>
