								...
								<div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
									...
									<c:forEach items="${hits }" var="hit" begin="1" end="3" varStatus="num" >
										<div class="d-flex rounded overflow-hidden mb-3">
											<img class="img-fluid" src="/resources/img/${hit.m_pimage }" style="width: 100px; height: 100px; object-fit: cover;" alt="">
											
											<a href="/marketDetail/${hit.mno }" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0" style="width: 300px; height:100px;">
