        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 45px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">장터</h1>
                ...
                <div class="col-lg-8">
                    ...
                    <c:forEach items="${products }" var="product">
                            ...
                            <div class="blog-item bg-light rounded overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        <small class="me-3"><i class="far fa-user text-primary me-2"></i>조회수 : ${product.m_hitcount }</small>
                                        <small><i class="far fa-calendar-alt text-primary me-2"></i>
                                        게시일 : <fmt:formatDate value="${product.m_regdate }" pattern="yyyy-MM-dd"/>
                                        </small>
                                    </div>
                                    <h4 class="mb-3">${product.m_pname }</h4>
                                    <p>가격 : ${product.price }원</p>
                                    <a class="text-uppercase" href="/marketDetail/${product.mno }">자세히 보기<i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
                        ...
                        <div class="col-12 wow slideInUp" data-wow-delay="0.1s">
                            ...
                            <button type="button" onclick="location.href='marketInsert'">물건 올리기</button>
                        </div>
                    </div>
                </div>
                <!-- Blog list End -->
