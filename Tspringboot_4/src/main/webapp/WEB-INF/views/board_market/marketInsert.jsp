...
<div class="container">
	<form action="marketInsert" method="post" enctype="multipart/form-data">
		<div class="form-group">
			<label for="m_pname">제목:</label> <input type="text"
				class="form-control" id="m_pname" placeholder="Enter product name"
				name="m_pname">
		</div>
		...
		<div class="form-group">
			<label for="m_writer">작성자:</label> <input type="text"
				class="form-control" id="m_writer" value="${principal.user.name }"
				name="m_writer" readonly="readonly">
		</div>

		<div class="form-group">
			<label for="m_pname">가격:</label> <input type="text"
